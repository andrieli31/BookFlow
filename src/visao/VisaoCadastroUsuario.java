...
//int ano= LocalDate.now().getYear();
		...
		for (Pessoa p : daoPessoa.listarPessoas()) {
			comboBox.addItem(String.valueOf(p.getCpf()));
		}
		...
		gl_contentPane.setHorizontalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup().addComponent(btnNewButton_2).addContainerGap())
						.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING)
										.addComponent(lblCpf, GroupLayout.DEFAULT_SIZE, 485, Short.MAX_VALUE)
										.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
												...
												.addGroup(gl_contentPane.createSequentialGroup()
														...
														.addComponent(btnListaUsuario, GroupLayout.PREFERRED_SIZE, 141,
												...
												.addGroup(gl_contentPane.createSequentialGroup().addGroup(gl_contentPane
														...
														.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
																...
																.addComponent(txtCpf, GroupLayout.DEFAULT_SIZE, 148,
																		Short.MAX_VALUE)
																.addComponent(txtEmail, GroupLayout.DEFAULT_SIZE, 148,
																		Short.MAX_VALUE)
																.addComponent(txtSenha, GroupLayout.DEFAULT_SIZE, 148,
																		Short.MAX_VALUE)))
												.addComponent(btnNewButton_3, GroupLayout.PREFERRED_SIZE, 139,
														GroupLayout.PREFERRED_SIZE))
												.addGap(197))
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_contentPane.createSequentialGroup()
												...
												.addComponent(btnNewButton_4, GroupLayout.PREFERRED_SIZE, 198,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_contentPane.createSequentialGroup().addGap(26).addComponent(
												scrollPane, GroupLayout.PREFERRED_SIZE, 493,
												GroupLayout.PREFERRED_SIZE)))
								.addGap(28)))));
		gl_contentPane.setVerticalGroup(gl_contentPane.createParallelGroup(Alignment.LEADING).addGroup(gl_contentPane
				...
				.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING).addGroup(gl_contentPane
						...
						.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_contentPane.createSequentialGroup().addComponent(lblNome).addGap(24)
										.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
												.addComponent(lblSobrenome)
												.addComponent(txtSobrenome, GroupLayout.PREFERRED_SIZE,
						...
						.addPreferredGap(ComponentPlacement.RELATED, 79, Short.MAX_VALUE).addComponent(lblNewLabel_4)
				...
				.addGap(29)
				.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE).addComponent(btnNewButton_2)
						.addComponent(btnNewButton_3))
				.addGap(114).addComponent(btnNewButton_4, GroupLayout.PREFERRED_SIZE, 44, GroupLayout.PREFERRED_SIZE)
				.addGap(317)));
